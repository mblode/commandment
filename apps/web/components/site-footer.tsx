  ...
  <footer className="flex flex-col items-center justify-center gap-2 bg-night px-6 pt-14 pb-8 text-night-muted text-sm">
    ...
    */}
    <div className="flex max-w-full flex-wrap items-center justify-center gap-1">
      Crafted by
      <a
        className="flex items-center gap-2 rounded-full py-1.5 pr-2.5 pl-1.5 hover:text-night-ink focus-visible:outline-2 focus-visible:outline-ring focus-visible:outline-offset-2"
    ...
    <div className="flex max-w-full flex-wrap items-center justify-center gap-2 text-night-muted">
      ...
      */}
      {version ? (
        <>
          <span className="text-night-muted">{version}</span>
          <span aria-hidden="true">·</span>
        </>
      ) : null}
      <a
        className="text-night-muted hover:text-night-ink focus-visible:outline-2 focus-visible:outline-ring focus-visible:outline-offset-2"
